...
export default function FrontDeskQueuingSystem() {
  // State
  ...
  return (
    <>
      <SEOWrapper
        title="Queuing System - SwiftPro eProcurement Portal"
        description="Manage patient queues efficiently: add, monitor, and process queue entries at the front desk."
        keywords="queue, front desk, patient management"
        canonical="/front-desk/queuing-system"
        robots="noindex, nofollow"
        ogImage="/assets/medteq-og-image.jpg"
        ogImageAlt="Medteq Healthcare System queue overview"
        structuredData={{
          "@context": "https://schema.org",
          "@type": "WebPage",
          name: "Front Desk Queuing System",
          description: "Front desk queue management page",
        }}
      />
