...
const FrontDeskAppointmentPage = () => {
  ...
  return (
    <div className="container mx-auto bg-gray-50 min-h-screen">
      <SEOWrapper
        title="Appointment - SwiftPro eProcurement Portal"
        description="Manage and review all appointments efficiently with filtering, booking, and analytics."
        keywords="appointments, scheduling, healthcare, front-desk"
        canonical="/front-desk/appointment"
        robots="noindex, nofollow"
        ogImage="/assets/medteq-og-image.jpg"
        ogImageAlt="Medteq Healthcare System appointment overview"
        structuredData={{
          "@context": "https://schema.org",
          "@type": "WebPage",
          name: "Appointment - Front Desk",
          description: "Front desk appointment management page",
        }}
      />
