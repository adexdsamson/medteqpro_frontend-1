...
/**
 * VitalSignsSection (Admin)
 * Displays patient vital signs table and provides a dialog to add a new record.
 * Auto-refetch of the GET request is handled via react-query invalidation in useAddVitalSigns.
 *
 * @example
 * <VitalSignsSection />
 */
